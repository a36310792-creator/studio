...
export const NewReleaseToast = ({ 
  ...
  useEffect(() => {
    ...
    const hideTimer = setTimeout(() => setIsVisible(false), 14500);
  ...
  return (
    ...
    >
      <div 
        onClick={onWatch}
        className="cursor-pointer bg-[#151b2b]/95 backdrop-blur-xl border border-[#00e5ff] rounded-2xl p-4 flex items-center justify-between shadow-[0_10px_40px_rgba(0,0,0,0.5),0_0_20px_rgba(0,229,255,0.25)] group hover:border-[#00e5ff] transition-all active:scale-95"
      >
